    ...
    <div class="card">
        <div class="card-body">
            <table class="table table-hover">
                ...
                <tbody>
                <%
                    java.util.List<lk.ijse.gdse.cms.dto.Complaints> complaints = (java.util.List<lk.ijse.gdse.cms.dto.Complaints>) request.getAttribute("complaints");
                    if (complaints != null && !complaints.isEmpty()) {
                        for (lk.ijse.gdse.cms.dto.Complaints complaint : complaints) {
                %>
                <tr>
...
<%
    lk.ijse.gdse.cms.dto.Complaints complaint = (lk.ijse.gdse.cms.dto.Complaints) request.getAttribute("complaint");
    if (complaint != null) {
%>
...
<%
    lk.ijse.gdse.cms.dto.Complaints viewComplaint = (lk.ijse.gdse.cms.dto.Complaints) request.getAttribute("viewComplaint");
